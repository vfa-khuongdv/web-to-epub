...
import { extractChapters, extractOne, exportEpub, fetchSupportedSites, uploadCover } from "./api";
  ...
  async function handleExport() {
    ...
    try {
      ...
      const blob = await exportEpub(
        { title: bookTitle || "Untitled Book", author: author || "Unknown", language, coverUrl },
        payload
      );
      ...
      a.href = url;
      a.download = `${(bookTitle || "book").replace(/[^a-z0-9]+/gi, "_")}.epub`;
